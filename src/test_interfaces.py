...
clean_block = ("prevHash", 1, 2, json.dumps({"hello":{"sailor":"the sailor"}}), 0, "writer signature", 1223123124134, "the hash")
genesis_block = ("0", 0, 0,  "genesis block", 0, "0", 13413413434, "0")
incorrect_type_block = ("prevHash", 1, 2, json.dumps({"hello":{"sailor":"the sailor"}}), 0, "writer signature", "1223123124134", "the hash")
missing_field_block = ("prevHash", 1, 2, json.dumps({"hello":{"sailor":"the sailor"}}), 0, "writer signature", 1223123124134)
non_json_block = ("prevHash", 1, 2, "string", 0, "writer signature", 1223123124134, "the hash")
